...
- [terminal-shields](https://github.com/seuthootDev/terminal-shields) - Shields-style neon terminal one-liner SVG badges for READMEs (static + live GitHub/npm, Simple Icons)
